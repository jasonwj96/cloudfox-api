...
func (r *AccountRepository) GetById(ctx context.Context, id string,
	username string) (*model.Account,
	error) {
...
func (r *AccountRepository) Create(ctx context.Context, account model.Account) (string, error) {
	argon2Hasher := argon2id.Argon2Hasher{}
	newPasswordHash, err := argon2Hasher.GenerateHash(account.Password)
	...
	err = r.pgxConnector.QueryRow(
		ctx,
		`SELECT sp_register_account($1, $2, $3, $4, $5, $6)`,
		account.Username,
		account.Fullname,
		newPasswordHash,
